...
There are three ways for individuals to define themselves: as distinct from others, based on their social groups or political groups, and according to their personal attributes[@id]. Such self-categorization changes over time, but highly related to one's attitudes. Groups with different features such as different age, gender, or education can have different opinions on certain issues. Currently, there are 18 states in the U.S that marijuana has been legalized. As a drug that can be tracked back in 1600, marijuana, has a dramatic history of its liberalization[@pbs]. Researches have shown that gender can drive a gap between support and not support the legalization of marijuana[@women]. Female tend to be less likely to support this idea[@women]. 

This paper employs the data collected from the U.S General Social survey in 2021 and R to explore how the attitudes regard to marijuana legalization varies due to characteristics of individuals[@citeR][@GSS]. We look through gender, age, education, political parties and race of respondents to verify if any of them leads to significant differences[@citeLahman] [@thereferencecanbewhatever].

Results indicates that individuals from different age groups and political parties present different attitudes of marijuana legalization. Strong democrat takes up the largest portion of the population who support it. At the same time, younger generations tend to show positive feedback than the older generation. Interestingly, it is evident that the gap resulted from gender shrinks over time. 
